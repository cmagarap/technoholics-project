    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-7">
                <div class="card">
                    <div class="header">
                        <h4 class="title"><b>Edit Categories </b></h4>
                    </div>
                    <div class="content">
                        <hr>
                        ...
                        <?php endif?>
                        <form action = "<?= $this->config->base_url() ?>Settings/edit_category_exec/<?= $this->uri->segment(3) ?>" method = "POST" enctype = "multipart/form-data">
                            
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Categoroy Name <font color="red">*</font></label>
