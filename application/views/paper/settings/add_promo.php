                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control border-input" placeholder="Promo Code" name = "promo_code" value = "<?= $promo_code ?>">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control border-input" placeholder="Promo Discount" name = "promo_discount" value = "<?= $promo_discount ?>">
                                        <?php if(validation_errors()):
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control border-input" placeholder="Promo Price Condition" name = "promo_condition" value = "<?= $promo_condition?>">
                                        <?php if(validation_errors()):
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="text-calendar" class="calendar form-control border-input file" name="promo_end" placeholder="promo_end"/>
                                        <?php if(validation_errors()):
