                        ...
                        <table class="table table-striped">
                            ...
                            foreach ($users as $users):?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success" href="<?= $this->config->base_url() ?>inventory/view/<?= $users->user_id ?>" title = "View Product Info" alt = "View Product Info">
                                            <span class="ti-eye"></span>
                                        </a>
                                        <a class="btn btn-warning" href="<?= $this->config->base_url() ?>inventory/edit/<?= $users->user_id ?>" title = "Edit Product" alt = "Edit Product">
