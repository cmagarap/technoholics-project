  ...
  <div id="container">
   ...
   <div id="body">
    <div> <center>
      ...
      <p><img src="https://image.ibb.co/icMrL7/confirmed.png" alt="" style="display: block; width:30%; max-width: 100%;height:auto;"/></p> </div>
      <table style="border:0;font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;" >
        <tr><td style="background-color:#ddd; padding:15px;">
          ...
          <br>
          <p style="font-family: Arial Narrow;font-size: 16px;color: black;padding: 0;margin:0;">Your <span style="color: #dc2f54"><b>Order #<?=$order->order_id?></b></span> is confirmed and will be out for shipment within the next 24 hours.</p>
        </td>
      </tr>
      <tr>
