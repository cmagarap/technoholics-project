    ...
    <div id="content">
        <div class="container">
            ...
            <div class="col-md-12" id="checkout">
                ...
                <div class="box">
                    <form Method="post" action="<?= base_url().'home/checkout3_exec';?>" id="form" ">
                        ...
                        <div class="box-footer">
                            <div class="pull-left">
                                <a href="<?= base_url().'home/checkout3'; ?>" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Delivery Method</a>
                            </div>
                            <div class="pull-right">

                                <button type="submit" id="bank_dep" class="btn btn-primary" style="display:none">Continue to Order review<i class="fa fa-chevron-right"></i></button>
