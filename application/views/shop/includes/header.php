                    ...
                    <div class="header">
                        <div class="head-t">
                            ...
                            <div class="header_right">
                                    <div class="clearfix"> </div>
                                     <a href="<?php echo $this->config->base_url() ?>home/load">View Cart <img src="<?php echo $this->config->base_url() ?>images/bag.png" alt="">
                                    </a> </br></br>
                               <div class="search">
                                    <form role="form" action="<?php echo $this->config->base_url() ?>home/search" method="post">
                                        <input type="text" value="" name="search" placeholder="search...">
                                        <button type="submit" style="border: 0; background: transparent">
                                        <img src="<?php echo $this->config->base_url() ?>/images/search.png" alt="submit" />
                                        </button>
                                    </form>
                                </div>
                                <div class="clearfix"> </div>
